...
| 13.   | Find Minimum in Rotated Sorted Array                              | [Find Minimum in Rotated Sorted Array](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/)                                                 | BINARY SEARCH |          | [View](# 13-Find-Minimum-in-Rotated-Sorted-Array)<br>[Video Solution](https://www.youtube.com/watch?v=Jin6vO0MdzY) |
# 4-Two-Sum-II
```java
class Solution {
